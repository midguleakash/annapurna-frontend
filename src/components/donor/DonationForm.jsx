...
function DonationForm() {
  ...
  return (
    <div style={{ padding: 16 }}>
      <h2 className="text-center pt-3 pb-3">Donate Food</h2>
      ...
      <form onSubmit={(e) => {
        ...
        <div className="mb-3 pe-5">
          <label htmlFor="exampleInputEmail1" className="form-label">Food Type</label>
          <input type="text" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Food Type" value={foodType}
            onChange={(e) => setFoodType(e.target.value)} />

        </div>
        <div className="mb-3 pe-5">
          <label htmlFor="exampleInputPassword1" className="form-label">Food Quantity</label>
